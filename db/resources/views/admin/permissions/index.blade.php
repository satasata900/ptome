                    ...
                    <div class="card-body">
                            ...
                            <div class="row d-flex justify-content-between">
                                ...
                                <div class="col-lg-3 col-sm-4">
                                    <div class="form-check text-right">
                                        <label class="form-check-label">
                                            <a class="btn btn-outline-info" href="{{ route('permissions_add') }}" id="addNewRole">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                <tr>
                                    <form method="GET" action="{{ route('permissions_search') }}" class="search-form" id="searchForm">
                                        <th></th>
                                        <th>
                                ...
                                @if(count($permissions) > 0)
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="checkbox" class="form-check-input" data-toggler="#checkAll" data-id="{{ $permission->id }}">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="dropdown-menu py-0" aria-labelledby="actionDropdown">
                                                <a class="dropdown-item py-3" href="{{ route('permissions_edit',$permission->id) }}">
                                                    <i class="mdi mdi-account-edit text-info"></i>
                                                    <span class="mx-2">Edit</span>
                                                </a>
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item py-3 delete-item" data-title="Delete Role ?" data-content="Do you want to delete this role ?" href="{{ route('permissions_delete',$permission->id) }}">
                                    ...
                                    <tr class="text-center">
                                        <td class="px-0" colspan="7">
                                            <div class="alert alert-danger bg-danger text-white py-4">
                                                ...
                                                <span class="mx-1">No Permissions to display</span>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
