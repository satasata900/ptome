    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">App Traders
                            <a class="btn btn-info" style="float: right;" href="{{ route('send_notification_for_all_traders') }}"> <i class="mdi mdi-bell text-warning"></i> Send Notifications for all traders</a>
                        </h4>
                            ...
                            <div class="col-xl-4 col-sm-6 grid-margin stretch-card">
                                <div class="card bg-dark">
                                    <div class="card-body">
                                        ...
                                        <h6 class="text-success font-weight-normal">Total traders</h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center"> Trader Name </th>
                                    <th class="text-center"> Action </th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <form method="GET" action="{{ route('trader_search') }}" class="search-form" id="searchForm">
                                        <th>
                                        ...
                                        <th>
                                            <div class="form-group mb-0">
                                                <input type="text" class="form-control text-white" name="trader_name" id="trader_name" placeholder="trader name" value="{{ Request::get('trader_name') }}">
                                                <i class="mdi mdi-close clear-input-btn"></i>
                                            </div>
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <div class="dropdown-menu py-0" aria-labelledby="actionDropdown">
                                                <a class="dropdown-item py-3" href="{{ route('trader_view',$org->id) }}">
                                                ...
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item py-3 delete-item" data-title="Delete trader ?" data-content="Do you want to delete this trader ?" href="{{ route('trader_delete',$org->id) }}">
                                    ...
                                    <tr class="text-center">
                                        <td class="px-0" colspan="7">
                                            <div class="alert alert-danger bg-danger text-white py-4">
                                                ...
                                                <span class="mx-1">No Traders to display</span>
                                            </div>
                                        </td>
                                    </tr>
                                @endif
