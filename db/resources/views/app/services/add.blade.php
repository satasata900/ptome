            ...
            <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-description"> Complete service information and click  "ADD" </p>

                        <form class="forms-sample mt-4" id="createForm" action="{{ route('services_store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
