        ...
        <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Send Notification <span class="text-info mx-1">{{ $user->full_name }}</span></h4>
                        <p class="card-description"> Complete information and click  "Send" </p>

                        <form class="forms-sample mt-4" id="updateForm" action="{{ route('app_users_send_notification_post',$user->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <button type="submit" class="btn btn-success mt-lg-5 mt-4">Send Notification</button>
