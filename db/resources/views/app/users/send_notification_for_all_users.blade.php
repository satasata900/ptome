        ...
        <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Send Notification <span class="text-info mx-1">for all users</span></h4>
                        <p class="card-description"> Complete information and click  "Send" </p>

                        <form class="forms-sample mt-4" id="updateForm" action="{{ route('send_notification_for_all_users_post') }}" method="POST" enctype="multipart/form-data">
                            @csrf
