        ...
        <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Update user wallet</h4>
                        <p class="card-description"> Complete user and wallet information and click  "Update" </p>

                        <form class="forms-sample mt-4" id="updateForm" action="{{ route('users_wallets_update',$userWallet->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select class="js-example-basic-single form-control forms-select" style="width:100%" name="wallet_name" id="wallet_name">
                                            @foreach($wallets as $wallet)
                                                <option value="{{ $wallet->id }}" @if($userWallet->wallet_id == $wallet->id) selected @endif>{{ $wallet->wallet_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select class="js-example-basic-single form-control forms-select" style="width:100%" name="owner_name" id="owner_name">
                                            @foreach($users as $user)
                                                <option value="{{ $user->id }}" @if($userWallet->user_id == $user->id) selected @endif>{{ $user->email }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="price" id="price" class="form-control no-space" placeholder="Wallet balance" value="{{ $userWallet->price }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-check form-check-flat form-check-info mb-2">
                                        <label class="form-check-label" for="hidden_wallet">
                                            <input type="checkbox" name="hidden_wallet" id="hidden_wallet" class="form-control" @if($userWallet->hidden == 1) checked @endif>
                                            Set as Hidden
                                        </label>
                                    </div>
                                </div>
